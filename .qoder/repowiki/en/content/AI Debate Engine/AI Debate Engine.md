...
## Core Components
- Debate Engine: Implements the 4-phase dialectical process, orchestrates agent prompts, and streams results via SSE.
...
- [index.js:26-311](file://dissensus-engine/server/index.js#L26-L311)
...
- Timeout protection: Debates abort after 5 minutes to prevent hanging connections.
...
**Diagram sources**
- [index.js:277-311](file://dissensus-engine/server/index.js#L277-L311)
...
- [debate-engine.js:253-380](file://dissensus-engine/server/debate-engine.js#L253-L380)
...
- Token limits: The engine sets a maximum token budget per agent call; tune via max_tokens for longer debates.
...
- Frontend timeout: Debates automatically abort after 5 minutes to prevent resource exhaustion.
...
## Conclusion
The AI Debate Engine implements a robust, real-time, multi-agent dialectical system with clear phases, distinct agent personalities, and transparent streaming. It integrates provider flexibility, optional staking enforcement, and shareable outputs, enabling scalable and engaging debates across diverse topics.
